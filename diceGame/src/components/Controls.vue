<template>
  <div class="wrapper-control">
    <button
      v-on:click="newGame"
      class="control btn-new"><i class="ion-ios-plus-outline"></i>
      New game
    </button>
    <button
      v-on:click="rollDice"
    ...
    <button
      ...
      class="control btn-hold"><i class="ion-ios-download-outline"></i>
      Hold</button>
...
export default {
  ...
  methods: {
    newGame(e){
      // kích hoạt sự kiện handleNewGame
      this.$emit('handleNewGame');
      console.log('New game');
    },
    rollDice(e){
      this.$emit('handlerollDice');
      console.log('rollDice game');
    }
  }
}
</script>
